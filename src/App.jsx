  ...
  return (
    <div style={{
      ...
      <div style={{textAlign:'center'}}>
        <p style={{fontSize:22,fontWeight:300,color:'#e9edef',marginBottom:8}}>WA Dashboard</p>
        <p style={{fontSize:13,lineHeight:1.7,color:'#8696a0',maxWidth:280}}>Pilih percakapan dari daftar untuk mulai membalas pesan</p>
      </div>
    </div>
  )
}
