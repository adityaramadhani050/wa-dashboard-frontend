...
function WelcomeView() {
  return (
    <div style={{
      ...
      background: 'var(--bg)', color: 'var(--muted)', gap: 16,
      ...
      <div style={{
        ...
        <svg viewBox="0 0 24 24" fill="var(--primary)" width="32" height="32" style={{opacity:0.5}}>
      ...
      <div style={{textAlign:'center'}}>
        <p style={{fontSize:17,fontWeight:600,color:'var(--text2)',marginBottom:6}}>RenusPro Chat</p>
        <p style={{fontSize:13,lineHeight:1.7,color:'var(--muted)',maxWidth:240}}>Pilih percakapan untuk mulai membalas pesan</p>
      </div>
    </div>
  )
}
